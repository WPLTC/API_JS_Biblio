...
Validation des Données : Utilisation de Zod pour valider les entrées (Users, Books, Authors).

Frontend : Page d'accueil dynamique avec EJS listant les livres, les auteurs , pagination et filtre des livres
